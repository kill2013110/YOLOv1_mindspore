...
if __name__ == "__main__":
    ...
    TOOD_ms = TOODDetector(mode="inference")

    match_pt_kv_mslist = tood_pth2ckpt(TOOD_ms.parameters_dict(), pth_path="/mnt/f/pretrain_weight/tood_r50_fpn_1x_coco.pth")

    context.set_context(mode=context.GRAPH_MODE, device_target='GPU', device_id=opt.device_id)
    ms.save_checkpoint(match_pt_kv_mslist, 'tood_pth2ms_jit.ckpt')
    ms.load_checkpoint('temp.ckpt', TOOD_ms)
